...
type ExpandedRouteConfig = Partial<Record<FileRouterInputKey, RouteConfig>>;
...
declare const withExponentialBackoff: <T>(doTheThing: () => Promise<T | null>, MAXIMUM_BACKOFF_MS?: number, MAX_RETRIES?: number) => Promise<T | null>;
declare function pollForFileData(fileKey: string, callback?: (json: any) => Promise<any>): Promise<null | undefined>;
declare function getUploadthingUrl(): string;
...
export { ALLOWED_FILE_TYPES, AllowedFileType, CombinedTypeValidator, ExpandedRouteConfig, FILESIZE_UNITS, FileData, FileRouterInputConfig, FileRouterInputKey, FileSize, FileSizeUnit, InternalFileTypeValidator, InternalMimeTypeValidator, MimeTypeZod, SizeUnit, UploadedFile, fileSizeToBytes, fillInputRouteConfig, generateUploadThingURL, getDefaultSizeForType, getTypeFromFileName, getUploadthingUrl, isRouteArray, pollForFileData, withExponentialBackoff };
